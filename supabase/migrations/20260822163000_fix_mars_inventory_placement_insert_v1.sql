...
-- ============================================================
-- BOBU MARS
-- Inventory Placement Runtime Fix V1
--
-- mars_colony_buildings has constructed_at + updated_at.
-- It does NOT have created_at.
--
-- The multi-instance placement RPC incorrectly attempted to
-- INSERT created_at, causing SAVE to fail at runtime.
-- ============================================================
...
'Creates a persistent physical Mars building instance from Colony inventory. Runtime insert matches mars_colony_buildings schema using constructed_at and updated_at.';
