...
'Owner-only Mars Pixel creative submission. Under-review and active advertisers may submit creatives for moderation. V35 qualifies creative allocation/status references to avoid PL/pgSQL output-column ambiguity; public exposure still requires active advertiser and active creative status.';
