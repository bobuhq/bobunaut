...
'Public owned Mars Pixel territories remain visible independently of commercial sale status and advertiser moderation. Advertiser identity and creative content are exposed only for active advertisers.';
