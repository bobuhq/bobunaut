      ...
      <shaderMaterial
        ...
        fragmentShader={`
          ...
          void main() {
            ...
            float lockedTerritoryColorActive =
              useTerritorySelectionColor;

            float lockedBorderPulse =
              0.62 +
              0.38 *
                (
                  0.5 +
